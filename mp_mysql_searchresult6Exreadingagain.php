...
//PHP+MySQL测试结果：[ { "id": 1, "idPoetryEx": "1", "PoetryExName": "村居的扩展阅读1", "idPoetryExAuthor": "李白", "idPoetryExAuthorDynasty": "唐朝", "PoetryExContent": "村居的扩展阅读1", "PoetryExPicURI": "/image/voice/lou.png" }, { "id": 2, "idPoetryEx": "2", "PoetryExName": "村居的扩展阅读2", "idPoetryExAuthor": "李白", "idPoetryExAuthorDynasty": "唐朝", "PoetryExContent": "村居的扩展阅读1", "PoetryExPicURI": "/image/voice/lou.png" }, { "id": 3, "idPoetryEx": "3", "PoetryExName": "村居的扩展阅读3", "idPoetryExAuthor": "李白", "idPoetryExAuthorDynasty": "唐朝", "PoetryExContent": "村居的扩展阅读1", "PoetryExPicURI": "/image/voice/lou.png" }, { "id": 4, "idPoetryEx": "4", "PoetryExName": "村居的扩展阅读4", "idPoetryExAuthor": "李白", "idPoetryExAuthorDynasty": "唐朝", "PoetryExContent": "村居的扩展阅读1", "PoetryExPicURI": "/image/voice/lou.png" } ]
...
if($link){
    ...
    //$countid = $_GET['countid'];//获取从小程序传递过来的id值，表示用户是第几次触发该事件；
    $countid = 1;
    $countid = $countid*6;
