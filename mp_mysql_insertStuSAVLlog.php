<?php
//用户浏览了任何别人上传的小视频或者音频，小程序端给我传过来idStu and idMedia；
//我在服务器端记录；
//执行sql：INSERT INTO Student_log_SAVL SET Student_log_SAVLStudentid_FK=1,Student_log_SAVLtime='2018-09-17 09:40:11',Student_log_SAVLShortVideoid_FK=1
...
if($link){
    ...
    //$Wordid = $_GET['idMedia'];//获取从小程序传递过来的id值，
    $Studentid = 1;
    $Mediaid = 1;
