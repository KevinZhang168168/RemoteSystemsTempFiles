...
if($link){
    ...
    $sql = "select idWord,Wordcontent,Wordidiom,Wordsentence_making,Wordmeaning,WordPicURI from Word where Wordcontent like '%".$keyword."%' or Wordidiom like '%".$keyword."%' or Wordsentence_making like '%".$keyword."%' or Wordmeaning like '%".$keyword."%' limit ".$countid.",6";
