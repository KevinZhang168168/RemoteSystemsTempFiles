...
if($link){
    ...
    $sql = "select idPoetry,PoetryName,idPoetryAuthor_FK,idPoetryAuthorDynasty_FK,PoetryContent,PoetryPic_id_FK from Poetry where PoetryName like '%".$keyword."%' or idPoetryAuthor_FK like '%".$keyword."%' or idPoetryAuthorDynasty_FK like '%".$keyword."%' or PoetryContent like '%".$keyword."%' limit 0,3";
