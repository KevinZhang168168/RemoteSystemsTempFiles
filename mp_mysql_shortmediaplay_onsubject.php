...
//PHP+MySQL测试结果：[ { "idmedia_below9": 1, "mediaid": "1", "SPcount": "2", "medianame": "王小虎的第一个视频", "Lcount": "4", "PicURI": "/image/media/lou.png", "Stuname": "王小虎", "StuPic": null } ]
...
if($link){
    ...
    class media_below9{
        public $idmedia_play;//这个media的数据库中的id；没有意义，可以不传。
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $media_below9->idmedia_below9=$idmedia_play++;//对的
