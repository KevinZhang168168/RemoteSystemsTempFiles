...
//PHP+MySQL测试结果：[ { "idmedia_below9": 1, "mediaid": "3", "SPcount": "1", "medianame": "米夏全的第一个视频", "Lcount": "2", "PicURI": "/image/media/lou.png", "Stuname": "米夏全", "StuPic": null } ]
...
//idStudent_shortVideo_log这个值-1；直到1为止，到头了。
...
if($link){
    ...
    class media_below9{
        public $idmedia_next;//这个media的数据库中的id；没有意义，可以不传。
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $media_below9->idmedia_below9=$idmedia_next++;//对的
