...
if($link){
    ...
    //目前这个解决办法不好，直接id-1，做演示可以，在实际过程中，id可能是不连续的，如何找到下一个记录？
    //$idMedia = $idMedia - 1;
    ...
    //解决办法是获取当前文件上一条与下一条记录的原理是上一条的sql语句，从news表里按从大到小的顺序选择一条比当前ID小的新闻,
    //下一条的sql语句，从news表里按从小到大的顺序选择一条比当前ID大的新闻。如果ID是主键或者有索引，可以直接查找：
    /*
     * 方法1：
        [sql] view plain copy 
